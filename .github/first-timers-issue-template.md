...
$DIFF
```
- [ ] If your changes were added to the `/src` directory, run `grunt build` to compile into `/dist/PublicLab.Editor.js`. Read our [installation guide](https://github.com/publiclab/PublicLab.Editor#installation) to know how to run this command.

- [ ] 💾 **Commit** your changes

- [ ] 🔀 **Start a Pull Request**. There are two ways how you can start a pull request:

1. If you are familiar with the terminal or would like to learn it, [here is a great tutorial](https://github.com/readme/guides/first-oss-contribution?utm_source) on how to send a pull request using the terminal.
